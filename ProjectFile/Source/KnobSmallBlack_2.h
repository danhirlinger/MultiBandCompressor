...
#ifndef __KnobSmallBlack_2__
#define __KnobSmallBlack_2__

//==============================================================================
// There are two options, Big White Knob with (below) and without the blue outline.
// Just inherit the desired LookAndFeel
class KnobSmallBlack_2 : public LookAndFeel_V4 // inherit from LookAndFeel_V4
{
public:
    
    KnobSmallBlack_2(){};
    virtual ~KnobSmallBlack_2(){};
                                      ...
                                      Slider &     slider )
    {
        ...
        knob = ImageCache::getFromMemory (BinaryData::knob_09_256_png, BinaryData::knob_09_256_pngSize);
...
private:
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (KnobSmallBlack_2);
};

#endif   // KnobSmallBlack_2
